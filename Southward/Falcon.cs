...
namespace Southward
{
    class Falcon
    {
        ...
        public Falcon(double vitality, double endurance, double mana, double stability, double agility, double charisma, double doubleimidation, double strength, double dexterity, double skill, double hearth, double spirit, double mind)
        {
            stance = 's';
        ...
        public void updateDefence()
        {
            ...
            windDef = 250 + (10 * hearth) + endurance;
            cleaDef = 60 + (10 * mind) + mana;
            corrDef = 80 + (10 * spirit) + mana;
            sunlDef = 150 + (10 * spirit) + mana;
            moonDef = 150 + (10 * spirit) + mana;
        ...
        public void updateBaseStats()
        {
            ...
            stamina = 24 + endurance;
            manaPodoubles = 9 * mana;
            load = 20 + (4 * stability);
